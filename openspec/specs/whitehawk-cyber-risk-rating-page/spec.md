# whitehawk-cyber-risk-rating-page Specification

## Purpose

The first WhiteHawk product chapter: a tier 1 case study of the Cyber Risk Rating product, covering
how one canonical risk report serves both an analyst audience that needs the evidence and a client
audience that needs the conclusion. Replaces the former platform stub page.
