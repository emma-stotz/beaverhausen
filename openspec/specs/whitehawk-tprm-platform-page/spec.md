# whitehawk-tprm-platform-page Specification

## Purpose

The fifth and last WhiteHawk product chapter, and the second tier 2: a case study of a third-party
risk management platform built for an unnamed global technology company monitoring more than 10,000
vendors, covering why identity had to be resolved before anything could be reported. Replaces the
former client-b stub page. It is also the first chapter to need an interactive artifact, which is
why the toggle slot enters the shared chapter schema here.
